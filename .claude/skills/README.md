...
| [onion-architecture](onion-architecture/SKILL.md) | Backend | Onion rings for server/ and reviewer-core/: where code lives, which way imports point |
| [next-best-practices](next-best-practices/SKILL.md) | Frontend | Next.js App Router, RSC boundaries, data fetching, optimization |
| [react-best-practices](react-best-practices/SKILL.md) | Frontend | React anti-patterns, state management, hooks rules |
| [frontend-ui-architecture](frontend-ui-architecture/SKILL.md) | Frontend | Where code lives: components, constants, helpers/utils, business logic, import boundaries |
...
| [pr-self-review](pr-self-review/SKILL.md) | Shared | Pre-PR review of all local changes with the skills above; blocks the PR on critical findings |
