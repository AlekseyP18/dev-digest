...
- Before `gh pr create` / `gh pr merge` or any "open a PR" request — run the `pr-self-review` skill;
  never open or merge unless `node .claude/skills/pr-self-review/scripts/gate.mjs` prints `ALLOWED`.
