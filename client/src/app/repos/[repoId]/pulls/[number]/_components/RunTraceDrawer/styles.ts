...
export const s = {
  ...
  promptState: { fontSize: 12, color: "var(--text-muted)" } satisfies CSSProperties,
  miniBtn: {
    display: "inline-flex",
    alignItems: "center",
  ...
  modalCount: { fontSize: 12, color: "var(--text-muted)", whiteSpace: "nowrap" } satisfies CSSProperties,
  modalScroll: { flex: 1, minHeight: 0, overflow: "auto" } satisfies CSSProperties,
  modalEmpty: { padding: "32px 24px", textAlign: "center", color: "var(--text-muted)", fontSize: 13 } satisfies CSSProperties,
  modalPre: { margin: 0, padding: "16px 24px", whiteSpace: "pre-wrap", fontSize: 12.5, lineHeight: 1.6 } satisfies CSSProperties,
  highlight: { background: "var(--accent)", color: "var(--bg-primary)", borderRadius: 2 } satisfies CSSProperties,
